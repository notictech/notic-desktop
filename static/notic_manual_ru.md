...
отдельных экранах (**screens**). Чтобы полностью выйти из программы, закройте окно или нажмите `Ctrl+Shift+Q`).
Окно имеет меню, где доступны некоторые основные функции, все пункты 
меню доступны через сочитания клавиш. Имеется возможность менять цветовую схему (`Ctrl+W`).
...
иконка приложения и кнопка Notifications не сигнализировали красным о непрочитанных оповещениях) или отредактировать 
